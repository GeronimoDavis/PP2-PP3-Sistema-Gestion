            ...
            if (isset($filters['sort_by'])) {
                switch ($filters['sort_by']) {
                    ...
                    case 'total_paid':
                        ...
                        break;
                    case 'status':
                        $sortBy = 'CASE WHEN COALESCE(SUM(pa.amount), 0) >= (COALESCE(SUM(i.quantity * i.price), 0) + COALESCE(SUM(e.price), 0)) THEN 2 WHEN COALESCE(SUM(pa.amount), 0) > 0 THEN 1 ELSE 0 END';
                        break;
                }
            }
