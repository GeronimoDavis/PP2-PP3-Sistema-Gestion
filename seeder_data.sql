...
('admin', 'Administrador1', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administrador'),
('contador1', 'Contador1', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Empleado'),
('admin2', 'Administrador2', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administrador'),
('contador2', 'Contador2', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Empleado');
...
-- INSERTAR PRODUCTOS
-- =============================================
INSERT INTO product (name, code, stock, purchase_price, sell_price, category_id) VALUES
-- MOTOR
('Filtro de Aceite Mann W67/2', 'FO-001', 50, 1250.00, 1800.00, 1),
('Filtro de Aceite Bosch 0451103079', 'FO-002', 30, 1180.00, 1700.00, 1),
('Bujía NGK BPR6ES', 'BU-001', 100, 850.00, 1200.00, 1),
('Bujía Bosch FR7DC', 'BU-002', 80, 920.00, 1300.00, 1),
('Junta de Culata Felpro', 'JC-001', 15, 4500.00, 6500.00, 1),
('Pistón STD Mahle', 'PI-001', 20, 3200.00, 4500.00, 1),
('Válvula de Admisión', 'VA-001', 25, 2800.00, 4000.00, 1),
('Válvula de Escape', 'VE-001', 22, 3100.00, 4400.00, 1),
('Empaquetadura de Motor', 'EM-001', 12, 5200.00, 7500.00, 1),
('Cadena de Distribución', 'CD-001', 18, 6800.00, 9500.00, 1),

-- TRANSMISIÓN
('Embrague Sachs 3000 951 301', 'EM-002', 8, 15000.00, 22000.00, 2),
('Disco de Embrague Valeo', 'DE-001', 12, 8500.00, 12000.00, 2),
('Plato de Embrague LUK', 'PE-001', 10, 12000.00, 17000.00, 2),
('Collarin de Embrague', 'CE-001', 15, 3500.00, 5000.00, 2),
('Aceite de Transmisión ATF', 'AT-001', 40, 2200.00, 3200.00, 2),
('Filtro de Transmisión', 'FT-001', 20, 1800.00, 2600.00, 2),
('Junta de Cárter', 'JCA-001', 25, 950.00, 1400.00, 2),
('Solenoide de Transmisión', 'ST-001', 8, 4200.00, 6000.00, 2),

-- FRENOS
('Pastillas de Freno Delanteras Bosch', 'PF-001', 60, 3500.00, 5000.00, 3),
('Pastillas de Freno Traseras Ferodo', 'PF-002', 45, 2800.00, 4000.00, 3),
('Disco de Freno Delantero Brembo', 'DF-001', 20, 8500.00, 12000.00, 3),
('Disco de Freno Trasero', 'DF-002', 18, 6200.00, 8800.00, 3),
('Líquido de Frenos DOT 4', 'LF-001', 35, 1200.00, 1800.00, 3),
('Cilindro de Freno', 'CF-001', 12, 4500.00, 6500.00, 3),
('Bomba de Freno', 'BF-001', 6, 12000.00, 17000.00, 3),
('Sensor ABS', 'SA-001', 10, 5500.00, 7800.00, 3),
('Manguera de Freno', 'MF-001', 30, 850.00, 1200.00, 3),

-- SUSPENSIÓN
('Amortiguador Delantero Monroe', 'AD-001', 25, 8500.00, 12000.00, 4),
('Amortiguador Trasero Bilstein', 'AT-002', 22, 9200.00, 13000.00, 4),
('Resorte Delantero', 'RD-001', 15, 3500.00, 5000.00, 4),
('Resorte Trasero', 'RT-001', 18, 3200.00, 4600.00, 4),
('Cazoleta de Amortiguador', 'CA-001', 40, 1250.00, 1800.00, 4),
('Taco de Motor', 'TM-001', 30, 2800.00, 4000.00, 4),
('Buje de Suspensión', 'BS-001', 50, 450.00, 650.00, 4),
('Rótula de Suspensión', 'RS-001', 20, 3800.00, 5400.00, 4),

-- DIRECCIÓN
('Bomba de Dirección Hidráulica', 'BD-001', 8, 18000.00, 25000.00, 5),
('Caja de Dirección', 'CD-002', 5, 25000.00, 35000.00, 5),
('Cremallera de Dirección', 'CR-001', 6, 22000.00, 31000.00, 5),
('Aceite de Dirección ATF', 'AD-002', 30, 1800.00, 2600.00, 5),
('Rótula de Dirección', 'RD-002', 25, 2500.00, 3600.00, 5),
('Barra de Dirección', 'BD-002', 12, 4200.00, 6000.00, 5),
('Volante de Dirección', 'VD-001', 8, 8500.00, 12000.00, 5),

-- ELÉCTRICO
('Batería 12V 60Ah Bosch', 'BA-001', 15, 12000.00, 17000.00, 6),
('Alternador Valeo', 'AL-001', 10, 15000.00, 21000.00, 6),
('Motor de Arranque Bosch', 'MA-001', 8, 18000.00, 25000.00, 6),
('Relay 12V 30A', 'RE-001', 100, 350.00, 500.00, 6),
('Fusible 10A', 'FU-001', 200, 45.00, 65.00, 6),
('Fusible 20A', 'FU-002', 150, 55.00, 80.00, 6),
('Cable de Batería', 'CB-001', 20, 850.00, 1200.00, 6),
('Bobina de Encendido', 'BE-001', 12, 3500.00, 5000.00, 6),
('Sensor de Temperatura', 'ST-002', 15, 1800.00, 2600.00, 6),
('Sensor de Presión', 'SP-001', 18, 2200.00, 3100.00, 6),

-- FILTROS
('Filtro de Aire Mann C25860', 'FA-001', 40, 1800.00, 2600.00, 8),
('Filtro de Combustible Bosch', 'FC-001', 35, 1200.00, 1700.00, 8),
('Filtro de Habitáculo', 'FH-001', 25, 950.00, 1400.00, 8),
('Filtro de Aceite Hidráulico', 'FO-003', 20, 1650.00, 2400.00, 8),
('Filtro de Transmisión Automática', 'FT-002', 15, 2200.00, 3100.00, 8),

-- LUBRICANTES
('Aceite Motor 10W-40 Shell', 'AM-001', 60, 1800.00, 2600.00, 9),
('Aceite Motor 5W-30 Mobil', 'AM-002', 50, 2200.00, 3100.00, 9),
('Aceite Motor 20W-50 YPF', 'AM-003', 40, 1600.00, 2300.00, 9),
('Grasa Multipropósito', 'GR-001', 30, 450.00, 650.00, 9),
('Aceite de Transmisión Manual', 'AT-003', 25, 1500.00, 2200.00, 9),
('Refrigerante Verde', 'RF-001', 35, 850.00, 1200.00, 9),
('Refrigerante Rojo', 'RF-002', 32, 920.00, 1300.00, 9),

-- NEUMÁTICOS
('Neumático 185/65R14 Pirelli', 'NE-001', 20, 15000.00, 21000.00, 10),
('Neumático 195/60R15 Michelin', 'NE-002', 18, 18000.00, 25000.00, 10),
('Neumático 205/55R16 Bridgestone', 'NE-003', 15, 22000.00, 30000.00, 10),
('Cámara de Aire R14', 'CA-002', 30, 850.00, 1200.00, 10),
('Válvula de Neumático', 'VN-001', 100, 120.00, 180.00, 10),
('Parche para Neumático', 'PN-001', 50, 85.00, 120.00, 10),

-- ILUMINACIÓN
('Lámpara H1 12V 55W Philips', 'LA-001', 50, 450.00, 650.00, 11),
('Lámpara H4 12V 60W Osram', 'LA-002', 45, 520.00, 750.00, 11),
('Lámpara H7 12V 55W', 'LA-003', 40, 480.00, 700.00, 11),
('Foco LED 12V', 'FL-001', 60, 350.00, 500.00, 11),
('Intermitente Delantero', 'ID-001', 25, 1200.00, 1700.00, 11),
('Intermitente Trasero', 'IT-001', 22, 950.00, 1400.00, 11),
('Luz de Freno', 'LF-002', 30, 850.00, 1200.00, 11),

-- REFRIGERACIÓN
('Radiador de Agua', 'RA-001', 8, 12000.00, 17000.00, 12),
('Bomba de Agua', 'BA-002', 12, 6500.00, 9200.00, 12),
('Termostato', 'TE-001', 25, 1800.00, 2600.00, 12),
('Manguera Superior de Radiador', 'MS-001', 15, 850.00, 1200.00, 12),
('Manguera Inferior de Radiador', 'MI-001', 18, 920.00, 1300.00, 12),
('Ventilador de Radiador', 'VR-001', 10, 8500.00, 12000.00, 12),
('Sensor de Temperatura', 'ST-003', 20, 1500.00, 2200.00, 12),

-- ESCAPE
('Silenciador Trasero', 'SI-001', 12, 4500.00, 6500.00, 13),
('Silenciador Delantero', 'SI-002', 10, 3800.00, 5400.00, 13),
('Caño de Escape', 'CE-002', 8, 2500.00, 3600.00, 13),
('Junta de Escape', 'JE-001', 40, 250.00, 350.00, 13),
('Catalizador', 'CA-003', 6, 25000.00, 35000.00, 13),
('Sensor de Oxígeno', 'SO-001', 15, 4500.00, 6500.00, 13),

-- COMBUSTIBLE
('Bomba de Combustible', 'BC-001', 10, 8500.00, 12000.00, 14),
('Filtro de Combustible', 'FC-002', 30, 1200.00, 1700.00, 14),
('Inyector de Combustible', 'IC-001', 20, 3500.00, 5000.00, 14),
('Regulador de Presión', 'RP-001', 12, 2800.00, 4000.00, 14),
('Tapa de Combustible', 'TC-001', 15, 850.00, 1200.00, 14),

-- HERRAMIENTAS
('Llave Inglesa 10mm', 'LI-001', 25, 450.00, 650.00, 15),
('Llave Inglesa 12mm', 'LI-002', 25, 480.00, 700.00, 15),
('Destornillador Phillips', 'DP-001', 30, 350.00, 500.00, 15),
('Destornillador Plano', 'DP-002', 28, 320.00, 460.00, 15),
('Alicate Universal', 'AU-001', 20, 850.00, 1200.00, 15),
('Martillo 500g', 'MA-002', 15, 1200.00, 1700.00, 15),
('Lima para Metal', 'LM-001', 12, 650.00, 950.00, 15),
('Prensa para Cojinetes', 'PC-001', 5, 4500.00, 6500.00, 15);
